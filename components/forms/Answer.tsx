	...
	return (
		<div className='mt-8'>
			<div className='flex flex-col justify-between gap-5 sm:flex-row sm:items-center sm:gap-2'>
				...
				<Button
					className='btn light-border-2 gap-2 rounded-md px-3 py-2 text-primary-500 shadow-none'
			...
			<Form {...answerForm}>
				<form className='mt-6 flex w-full flex-col gap-10' onSubmit={answerForm.handleSubmit(handleCreateAnswer)}>
					<FormField
								...
								<FormControl className='mt-3.5'>
									<Editor
										...
										init={{
											...
											content_css: mode === 'dark' ? 'dark' : 'fabric'
										}}
									/>
								</FormControl>
